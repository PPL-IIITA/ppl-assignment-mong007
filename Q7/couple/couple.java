...
public couple(girl g1, boy b1) {
    this.g = g1;
    this.b = b1;
    this.b_id = Integer.parseInt(this.b.name.substring(this.b.name.length() - 1));
}
/**  
...
/**
 * This function acts as comparator to sort Couples in order of name of object of boy class.
 */
@Override
          public int compareTo(couple o) {
        return Integer.parseInt(this.b.name.substring(this.b.name.length() - 1)) > Integer.parseInt(o.b.name.substring(o.b.name.length() - 1)) ? 1 : (Integer.parseInt(this.b.name.substring(this.b.name.length() - 1)) < Integer.parseInt(o.b.name.substring(o.b.name.length() - 1)) ? -1 : 0);
          }
/**
 * This class is comparator to sort Couples in order of id of object of boy class.
 */
public static class OrderByBoy implements Comparator<couple> {

        @Override
        public int compare(couple o1, couple o2) {
            return o1.b_id > o2.b_id ? 1 : (o1.b_id < o2.b_id ? -1 : 0);
        }
    }
    }
