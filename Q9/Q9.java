...
public class Q9
{
	...
	for(i=1;i<100;i++) {
            Random(b1, giv);
            int a15 = g.get(i).mk_pair(b1,giv);
            if(a15!=-1){
 ...
 */
    public static <E extends Comparable<E>> void Random(E[] a, int s) {
        for (int i = 0; i < s; i++) {                         /**New Data Structure*/
            int small = i;
